$(document).ready(function(){
    ...
    $(".firstRow .bloque1").click(function(){
        ...
        $(".bigImage").fadeIn();
        $(".bigImage img").attr("src","images/1.jpg");
        var newHTML="images/descripciones/1.html"
        $('.descripcion').load(newHTML);
        flag=1;
    });
    $(".firstRow .bloque2").click(function(){
        $(".bigImage").fadeIn();
        $(".bigImage img").attr("src","images/2.jpg");
        var newHTML="images/descripciones/2.html"
        $('.descripcion').load(newHTML); 
        flag=2;
    });
    $(".firstRow .bloque3").click(function(){
        $(".bigImage").fadeIn();
        $(".bigImage img").attr("src","images/3.jpg");
        var newHTML="images/descripciones/3.html"
        $('.descripcion').load(newHTML);
        flag=3;
    });
    ...
    $(".secondRow .bloque1").click(function(){
        $(".bigImage").fadeIn();
        $(".bigImage img").attr("src","images/4.jpg");
        var newHTML="images/descripciones/4.html"
        $('.descripcion').load(newHTML);
        flag=4;
    });
    $(".secondRow .bloque2").click(function(){
        $(".bigImage").fadeIn();
        $(".bigImage img").attr("src","images/5.jpg");
        var newHTML="images/descripciones/5.html"
        $('.descripcion').load(newHTML);
        flag=5;
    });
    $(".secondRow .bloque3").click(function(){
        $(".bigImage").fadeIn();
        $(".bigImage img").attr("src","images/6.jpg");
        var newHTML="images/descripciones/6.html"
        $('.descripcion').load(newHTML);
        flag=6;
    });
    ...
    $(".thirdRow .bloque1").click(function(){
        $(".bigImage").fadeIn();
        $(".bigImage img").attr("src","images/7.jpg");
        var newHTML="images/descripciones/7.html"
        $('.descripcion').load(newHTML);
        flag=4;
    });
    $(".thirdRow .bloque2").click(function(){
        $(".bigImage").fadeIn();
        $(".bigImage img").attr("src","images/8.jpg");
        var newHTML="images/descripciones/8.html"
        $('.descripcion').load(newHTML);
        flag=5;
    });
    $(".thirdRow .bloque3").click(function(){
        $(".bigImage").fadeIn();
        $(".bigImage img").attr("src","images/9.jpg");
        var newHTML="images/descripciones/9.html"
        $('.descripcion').load(newHTML);
        flag=6;
    });
